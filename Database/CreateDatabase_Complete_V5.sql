...
--   - Username field per riferimento rapido
--   - ResourceType e ResourceId per tracking preciso
--   - TenantId per isolamento multi-tenant
--   - Severity levels (Info, Warning, Error, Critical)
--   - Success/Failure tracking
--   - ErrorMessage per operazioni fallite
--   - 8 indici ottimizzati per query veloci
-- • Tutte le funzionalità V4 mantenute
-- ================================================
-- CHANGELOG V4:
...
-- AuditLogs (Enhanced for GDPR/SOC2 Compliance)
...
BEGIN
    ...
    PRINT '  ✓ AuditLogs creata con 8 indici ottimizzati (GDPR/SOC2 compliant)';
END
GO
