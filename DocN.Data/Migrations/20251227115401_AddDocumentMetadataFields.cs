        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AzureOpenAIEndpoint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AzureOpenAIKey = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EmbeddingDeploymentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChatDeploymentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedText = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    SuggestedCategory = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CategoryReasoning = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ActualCategory = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AITagsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AIAnalysisDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_ActualCategory",
                table: "Documents",
                column: "ActualCategory");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_SuggestedCategory",
                table: "Documents",
                column: "SuggestedCategory");
