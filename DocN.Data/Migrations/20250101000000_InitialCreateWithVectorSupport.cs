...
{
    /// <inheritdoc />
    public partial class InitialCreateWithVectorSupport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create Documents table with VECTOR column for SQL Server 2025
            migrationBuilder.CreateTable(
                name: "Documents",
                columns: table => new
                {
                    ...
                    SuggestedCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
        ...
        {
            migrationBuilder.DropTable(name: "AIConfigurations");
