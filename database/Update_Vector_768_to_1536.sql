-- ============================================================================
-- Migration Script: Update VECTOR dimension from 768 to 1536
-- ============================================================================
-- This script updates existing databases that were created with VECTOR(768)
-- to use VECTOR(1536) to match the application requirements.
--
-- IMPORTANT: This script will:
-- 1. Drop existing vector data (embeddings will need to be regenerated)
-- 2. Alter column types from VECTOR(768) to VECTOR(1536)
-- 3. Update stored procedures to use VECTOR(1536)
--
-- Run this script only if you have a database with VECTOR(768) columns
-- ============================================================================
...
PRINT '============================================================================';
PRINT 'Starting migration from VECTOR(768) to VECTOR(1536)';
PRINT '============================================================================';
PRINT '';
...
-- ============================================================================
PRINT 'Step 3: Updating Documents.Embedding column to VECTOR(1536)...';
...
BEGIN TRY
    ...
    BEGIN
        ...
        ALTER COLUMN [Embedding] VECTOR(1536) NULL;
        
        PRINT '✓ Documents.Embedding updated to VECTOR(1536)';
    END
    ELSE
    BEGIN
...
-- ============================================================================
PRINT 'Step 4: Updating DocumentChunks.Embedding column to VECTOR(1536)...';
...
BEGIN TRY
    ...
    BEGIN
        ...
        PRINT '✓ DocumentChunks.Embedding updated to VECTOR(1536)';
    END
    ELSE
    BEGIN
...
-- ============================================================================
PRINT 'Step 5: Updating stored procedures to use VECTOR(1536)...';
PRINT '';
...
PRINT '2. Re-process documents to regenerate embeddings with 1536 dimensions';
PRINT '3. Verify that document uploads and searches work correctly';
PRINT '';
